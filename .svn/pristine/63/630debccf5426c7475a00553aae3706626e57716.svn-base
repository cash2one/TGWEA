...
<body>
    <div id="main">
	 ...
	 <div class=" bcolor borderradius adminico" style="margin-top:3rem;"><a name="addwarehouse" href="javascript:void(0);" onclick="javascript:f_addOwneradmin();"><img src='${ctx}/images/ico/addcust.png' alt='添加管理员' title='添加管理员'/></a></div>
