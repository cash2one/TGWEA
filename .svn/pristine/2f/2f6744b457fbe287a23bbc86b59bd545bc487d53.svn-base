   ...
   <div class="sos">
    <div class="fleft sysf">扫一扫，轻松下载：</div> <div class="fleft qrcode"><img id="androidimg"/></div>
        ...
        <%@ include file="/admin/top.jsp" %>
  			...
  			<input type="hidden" id="v1" value="<s:property value='#parameters.ownerNum[0]' />"/>
...
$(function() {
    ...
    $("#dlapp").click(function(){
    	...
    	$.ligerDialog.open({ height: 500,width:500,title:'App下载',url: '${ctx}/download/'+$("#v1").val()+"/"+$("#v1").val()+'.html' });
