...
@Service(value = "wqrcode") @Scope("prototype")
public class WQrcodeAction extends WCommonBaseAction{
	// 图片宽度的一般  
    ...
    public BufferedImage genBarcode(String content, int width,  
    ...
    @Action(value="qrcode",results = { @Result(name="success",type="stream",params={"contentType","applicationnd.png", "inputName","inputStream"})})
    public String qrcode() throws Exception {
    	...
    	link="http://" +link;
		 ...
		 destTmpName.append("/images/ico/");
		 destTmpName.append("taoguan.png");
		 
	            ImageIO.write(genBarcode(link, 200, 200, destTmpName.toString()),"png",imOut); 
