...
public class WOwnerService extends OwnerService implements IWOwnerService{
	...
	/* (non-Javadoc) 暂停企业服务
	 * @see com.etaoguan.wea.client.web.service.IWOwnerService#updateBatchSuspendOwner(java.lang.String[])
	 */
	@Override
	...
	/* (non-Javadoc)恢复企业服务
	 * @see com.etaoguan.wea.client.web.service.IWOwnerService#startSuspendOwner(java.lang.String[])
	 */
	@Override
	public void updateStartSuspendOwner(String[] ownerNums) {
		for(String ownerNum:ownerNums){
			stratOwner2InactiveStatus(ownerNum);
		}
	}
}
