        ...
        l = function(a, b) {
            ...
            if ("check" == b) {
                if (!a.userlockRatio && "true" == d.getCustomData("isReady")) {
                    ...
                    e = 1E3 * f / c;
                    a.lockRatio = !1; ! f && !c ? a.lockRatio = !0 : !isNaN(d) && !isNaN(e) && Math.round(d) == Math.round(e) && (a.lockRatio = !0)
                }
