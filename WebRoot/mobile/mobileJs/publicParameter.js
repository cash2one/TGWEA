...
var errImg =  "mobileImg/nopic.jpg";
var parametersClass = {
index: 1,					//幻灯片播放选择按钮编号
timeout: 0,
...
userGetProductInfos: "mGetProductInfo.action",                  //用户获取产品多个信息
userGetProductInfo: "mobile/product/detail_",                   //用户获取产品信息
...
userGetVerifiCode: "getRegCode.action",							//获取手机验证码
...
adminGetWaitingAudit: "mUnauditedOrders.action",                    //管理员获取待审核订单
adminGenerateOrder: "mGenOrder.action",                             //管理生成订单
...
getPayType: "mGetOwnerSupportPayType.action"						//支付类型接口
};
