...
<body>
	<div id="main">
		...
		<div id="maincontent" position="center" title=" "
			style="padding-left:7rem;padding-top:1rem;">
                <div id="beautiful">
                <div id="etitle" style="margin-bottom:9rem;">
               <div id="whereimg"><img src="../images/adminBP/add_android_version.webp"/></div>
               <div id="whatfont">添加安卓版本</div>
                <div class="both"></div>
               </div>
			<form name="aavForm" method="post" id="aavForm">
				<ul>
				<li class="li-line">
					...
					<li class="li-line"><i class="i-spacing-first"> 详细版本号： </i> <i
					...
					<li class="li-line" style="margin-left:6rem;margin-top:7rem;"><input type="submit" value="提交"
						id="saveAndroid" name="saveAndroid" class="button-submit" /> <input
...
$(function() {
    ...
    formvalidate = $("#aavForm").validate({
        ...
        messages:{ 
        	"appName": { 
    			rangelength: '名称应在2-30个字之间'  
    		},
            "versionCode":{ 
                rangelength:'详细版本号应在1-30个字之间'
            }
        }
	...
	function f_submitForm() {
		...
		if(fullPath.length > 5){//代表已上传APP
			...
			var param = {
				...
				"androidVersion.activeFlag" : activeFlag,
			...
			j4tg.ajaxPost("${ctx}/admin/wAddandriodversionnow.action", "json", false,
					param, function(data) {
