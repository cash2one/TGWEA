    ...
    <div id="main">
        ...
        <div id="maincontent" position="center" title=" ">
			...
			支付宝帐户：
	                ...
	                <i class="i-spacing-follow">
	                    <input type="text" id="ownerAccountName" name="ownerAccountName" />
	                </i>
	        ...
	        合作身份者：
	                ...
	                <i class="i-spacing-follow">
	                    <input type="text" id="userPartner" name="userPartner" /><lable style="color:red;">登录支付宝平台获取</lable>
	                </i>
	            </li>
			...
			安全检验码：
	                ...
	                <i class="i-spacing-follow">
	                    <input type="text" id="userKey" name="userKey" /><lable style="color:red;">登录支付宝平台获取</lable>
	                </i>
...
<script type="text/javascript">
    ...
    function f_submitForm() {
        ...
        var userPartner = $.trim($("#userPartner").val());
        var userKey = $.trim($("#userKey").val());
    	var ownerAccountName = $.trim($("#ownerAccountName").val());

        var param = {
        	"alipayKeys.ownerNum": ownerNum,
            "alipayKeys.ownerPartner": userPartner,
            "alipayKeys.ownerKey": userKey,
            "alipayKeys.ownerAccountName": ownerAccountName

        }

        j4tg.ajaxPost("${ctx}/admin/wAddAlipayKeys.action", "json", false, param,
        function(data) {

            if (data.status == "S") {
                $.ligerDialog.success('保存成功');
                location.href = "${ctx}/admin/wListAlipaykeys.action";
            }else{
