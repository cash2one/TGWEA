            ...
            <div id="batchbar" style="overflow:hidden">
                <ul>
                    <li>
                        ...
                        <i class="i-spacing-first">
                            <input name="batchSuspend" onclick="javascript:f_startOwner();" type="button"
                            id="startOSuspend" value="恢复服务" />
                        </i>
                        <i class="i-spacing-follow">
...
<script type="text/javascript">
    ...
    function f_startOwner(rowid) {
        ...
        $.ligerDialog.confirm('确定要恢复服务么?',
        function(yes) {
            if (yes) {

                j4tg.ajaxPost("${ctx}/admin/wStartOwner.action", "json", false, param,
                function(data) {
                    if (data.status == "S") {
                        $.ligerDialog.success('操作成功');
                        f_refreshOwnerGridData();
